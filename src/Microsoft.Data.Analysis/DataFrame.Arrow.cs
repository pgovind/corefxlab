...
namespace Microsoft.Data.Analysis
{
    public partial class DataFrame
    {
        ...
        public IEnumerable<RecordBatch> ToArrowRecordBatches()
        {
            ...
            List<Field> fields = new List<Field>(columnCount);
            ...
            Field structField = new Field.Builder().Name("Struct").Nullable(false).DataType(structType).Build();
            Schema schema = schemaBuilder.Field(structField).Build();
            ...
            do
            {
                ...
                yield return new RecordBatch(schema, new IArrowArray[]
                    {
                        new StructArray(structType,
                            numberOfRowsInThisRecordBatch,
                            arrays,
                            ArrowBuffer.Empty
                        ),
                    }, numberOfRowsInThisRecordBatch);
