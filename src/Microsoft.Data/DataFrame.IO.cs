...
namespace Microsoft.Data
{
    ...
    public partial class DataFrame
    {
        private static Type GuessKind(int col, List<string[]> read)
        {
            ...
            {
                if (col >= line.Length)
                    throw new FormatException(string.Format("Line {0} has less columns than expected.", nbline + 1));
                ...
                // ML.NET does not like non float columns. Hack to only parse values as floats
                ...
                //{
                //    uint.Parse(val);
                //    res = DetermineType(nbline == 0, typeof(uint), res);
                //    ++nbline;
                //    continue;
                //}
                //catch (Exception /*e*/)
                ...
                //{
                //    long.Parse(val);
                //    res = DetermineType(nbline == 0, typeof(long), res);
                //    ++nbline;
                //    continue;
                //}
                //catch (Exception /*e*/)
                ...
                //{
                //    double.Parse(val);
                //    res = DetermineType(nbline == 0, typeof(double), res);
                //    ++nbline;
                //    continue;
                //}
                //catch (Exception /*e*/)
        ...
        private static Type MaxKind(Type a, Type b)
        {
            ...
            if (a == typeof(long) || b == typeof(long))
                return typeof(long);
            if (a == typeof(uint) || b == typeof(uint))
                return typeof(uint);
